  ...
  return (
    <div className={styles.authLayout}>
      <div className={styles.hero}>
        ...
        <h1>Let Fixzep concierge your next service visit.</h1>
        <p>Register to unlock faster scheduling, real-time approvals, and executive-grade craftsmanship tracking.</p>
      </div>
      <section className={styles.panel}>
        <div>
          <h2>Create your client account</h2>
          <p className={styles.subtitle}>We will send confirmations to your email and mobile.</p>
        </div>

        <form className={styles.form} onSubmit={handleSubmit(onSubmit)}>
          <TextField label="Full name" placeholder="Aarav Patel" error={errors.name?.message} {...register('name')} />
          <TextField label="Work email" placeholder="aarav@venturefund.com" error={errors.email?.message} {...register('email')} />
