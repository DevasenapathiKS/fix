        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-start gap-2 text-sm">
              ...
              <span>Serving OMR (Old Mahabalipuram Road), Chennai</span>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="text-sm">Carpentry Services</li>
              <li className="text-sm">Appliance Repair</li>
              <li className="text-sm">Home Cleaning</li>
              <li className="text-sm">Painting Services</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-center gap-2 text-sm">
                ...
                <a href="tel:+918065429026" className="hover:text-primary-400 transition-colors">
                  +91 80654 29026
                </a>
              </li>
              <li className="flex items-center gap-2 text-sm">
      ...
      <div className="border-t border-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-sm text-gray-400">
              © {new Date().getFullYear()} Fixzep. All rights reserved.
            </p>
