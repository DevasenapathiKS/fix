...
The portal boots on `http://localhost:5173`. Point `VITE_API_URL` to the running Fixzep backend (defaults to `http://localhost:4000/api`).

## 2. Environment

| Variable | Description | Default |
| --- | --- | --- |
| `VITE_API_URL` | Base URL for Fixzep backend REST API | `http://localhost:4000/api` |
